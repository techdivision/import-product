...
/**
 * TechDivision\Import\Product\Actions\Processors\ProductVarcharUpdateProcessor
 *
 * NOTICE OF LICENSE
 *
...
class ProductVarcharUpdateProcessor extends AbstractUpdateProcessor
{
    ...
    protected function getStatements()
    {
        ...
        return array(
            $utilityClassName::UPDATE_PRODUCT_VARCHAR => $this->getUtilityClass()->find($utilityClassName::UPDATE_PRODUCT_VARCHAR)
        );
    }
}
