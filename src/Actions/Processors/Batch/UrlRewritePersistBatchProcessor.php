...
/**
 * TechDivision\Import\Product\Actions\Processors\Batch\UrlRewritePersistBatchProcessor
 *
 * NOTICE OF LICENSE
 *
...
/**
 * The URL rewrite persist batch processor implementation.
 *
 * @author    Tim Wagner <t.wagner@techdivision.com>
 * @copyright 2016 TechDivision GmbH <info@techdivision.com>
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
 ...
 * @link      http://www.techdivision.com
 */
class UrlRewritePersistBatchProcessor extends AbstractPersistBatchProcessor
{
    ...
    protected function getStatement()
    {
        ...
        return $utilityClassName::CREATE_URL_REWRITE;
    }
}
