...
/**
 * TechDivision\Import\Product\Actions\Processors\Batch\StockStatusRemoveBatchProcessor
 *
 * NOTICE OF LICENSE
 *
...
/**
 * The stock status remove batch processor implementation.
 *
 * @author    Tim Wagner <t.wagner@techdivision.com>
 * @copyright 2016 TechDivision GmbH <info@techdivision.com>
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
 ...
 * @link      http://www.techdivision.com
 */
class StockStatusRemoveBatchProcessor extends AbstractRemoveBatchProcessor
{
    ...
    protected function getStatement()
    {
        ...
        return $utilityClassName::REMOVE_STOCK_STATUS_BY_SKU;
    }
}
